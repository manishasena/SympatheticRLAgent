...
class DQNGhost:
    def __init__(self,params):
        ...
        self.model_bsm = Model([self.inputs, self.power, self.x_self, self.y_self, self.x_other, self.y_other], self.bsm, name='q_net_bsm')
        self.outputs = Activation(softmax)(self.bsm)
        ######
        #self.outputs = Dense(self.num_actions, activation = "softmax")(x)

        self.model = Model([self.inputs, self.power, self.x_self, self.y_self, self.x_other, self.y_other], self.outputs, name='q_net_ghost')
