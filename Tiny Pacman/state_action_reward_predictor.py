...
class SA_reward:
    def __init__(self,params):
        ...
        self.reward = params['number_reward_features']
        ...
        x = Dense(self.reward)(x)
        self.outputs = Activation(sigmoid)(x)
        self.model = Model([self.inputs, self.power, self.x_self, self.y_self, self.x_other, self.y_other, self.action], self.outputs, name='sa_reward_function')
