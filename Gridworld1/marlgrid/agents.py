...
class GridAgentInterface(GridAgent):
    ...
    def get_view_exts(self):
        ...
        if dir == 0:  # 1
            ...
            topX = self.pos[0] - self.view_offset - self.view_size // 2
            topY = self.pos[1] - self.view_size // 2
        # Facing down
        elif dir == 1:  # 0
            ...
            topX = self.pos[0] - self.view_size // 2
            topY = self.pos[1] - self.view_offset - self.view_size // 2
        # Facing left
        elif dir == 2:  # 3
            #topX = self.pos[0] - self.view_size + 1 + self.view_offset
            #topY = self.pos[1] - self.view_size // 2
            topX = self.pos[0] - self.view_size + 1 + self.view_offset + self.view_size // 2
            topY = self.pos[1] - self.view_size // 2
        # Facing up
        elif dir == 3:  # 2
            #topX = self.pos[0] - self.view_size // 2
            ...
            topX = self.pos[0] - self.view_size // 2
            topY = self.pos[1] - self.view_size + 1 + self.view_offset + self.view_size // 2
        else:
